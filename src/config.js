...
const appCfg = {
    routes:[
        ...
        {navItem:true, exact:true, path:"/tours",name:"Tours",view:<Tours/>},
...
const APP_LINKS = {
    messages: "http://localhost/camping/public/message.php",
    register: "register.php",
    users: "http://localhost/camping/public/user.php"
};
