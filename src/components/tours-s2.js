...
class ToursS2 extends Component{
    render(){
        return(    
            <Container fluid className="tours-s2 d-flex minh-50vh bg-white align-items-center py-5 border-top border-dark">
